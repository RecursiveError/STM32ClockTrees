...
const ClkLPUARTOutput = struct {
  pub fn get(_:*const ClkLPUARTOutput) comptime_int {
      const from_input = LPUARTMult_inst.get();
      if(from_input < 0){
...
pub const ClkLPUARTOutput_inst = ClkLPUARTOutput{};
