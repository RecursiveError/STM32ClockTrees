...
const FDCAN1Mult = struct {
  value: FDCAN1MultConf,
  pub fn get(comptime self: FDCAN1Mult) comptime_int {
      return switch(self.value) {
.APBPrescaler => APBPrescaler_inst.get(),
 .HSIKER => HSIKER_inst.get(),
 .HSEOSC => HSEOSC_inst.get(),
...
const FDCAN1output = struct{
  pub fn get(_:*const FDCAN1output) comptime_int{
      return FDCAN1Mult_inst.get();
  }
};
...
const FDCAN1Mult_inst = FDCAN1Mult{ .value = conf.FDCAN1Mult};
pub const FDCAN1output_inst = FDCAN1output{};
