...
const LPUART3Mult = struct {
  value: LPUART3MultConf,
  pub fn get(comptime self: LPUART3Mult) comptime_int {
      return switch(self.value) {
.APBPrescaler => APBPrescaler_inst.get(),
 .SysCLKOutput => SysCLKOutput_inst.get(),
 .HSIRC => HSIRC_inst.get(),
...
const LPUART3output = struct{
  pub fn get(_:*const LPUART3output) comptime_int{
      return LPUART3Mult_inst.get();
  }
};
...
const LPUART3Mult_inst = LPUART3Mult{ .value = conf.LPUART3Mult};
pub const LPUART3output_inst = LPUART3output{};
