...
const I2S2ClkOutput = struct{
  pub fn get(_:*const I2S2ClkOutput) comptime_int{
      return SysCLKOutput_inst.get();
  }
};
const I2S3ClkOutput = struct{
  pub fn get(_:*const I2S3ClkOutput) comptime_int{
      return SysCLKOutput_inst.get();
  }
};
...
const HCLKDiv2 = struct {

        pub fn get(_:*const HCLKDiv2) comptime_int {
...
const SDIOHCLKDiv2 = struct{
  pub fn get(_:*const SDIOHCLKDiv2) comptime_int{
      return HCLKDiv2_inst.get();
  }
};
...
const SDIOClkOutput = struct{
  pub fn get(_:*const SDIOClkOutput) comptime_int{
      return AHBOutput_inst.get();
  }
};
...
pub const I2S2ClkOutput_inst = I2S2ClkOutput{};
pub const I2S3ClkOutput_inst = I2S3ClkOutput{};
...
const HCLKDiv2_inst = HCLKDiv2{};
pub const SDIOHCLKDiv2_inst = SDIOHCLKDiv2{};
pub const HCLKOutput_inst = HCLKOutput{};
pub const SDIOClkOutput_inst = SDIOClkOutput{};
...
const PLLMUL_inst = PLLMUL{ .value = conf.PLLMUL};
 ...
 _ = I2S2ClkOutput_inst.get();
 _ = I2S3ClkOutput_inst.get();
 _ = AHBOutput_inst.get();
 _ = SDIOHCLKDiv2_inst.get();
 _ = HCLKOutput_inst.get();
 _ = SDIOClkOutput_inst.get();
