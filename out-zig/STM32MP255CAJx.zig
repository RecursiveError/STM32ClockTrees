...
pub fn Clock(comptime conf: Config) type {
    const ClockStruct = struct {
        ...
        const LVDSMultType = struct {
            value: LVDSMultConf,
            pub fn get(comptime self: LVDSMultType) comptime_int {
                return switch (self.value) {
                    .XBAR32Output => XBAR32Output.get(),
                    .HSEOSC => HSEOSC.get(),
                };
        ...
        const LVDSoutputType = struct {
            pub fn get(_: *const LVDSoutputType) comptime_int {
                return LVDSMult.get();
            }
        };
        ...
        const LVDSMult = LVDSMultType{ .value = conf.LVDSMult };
        pub const LVDSoutput = LVDSoutputType{};
