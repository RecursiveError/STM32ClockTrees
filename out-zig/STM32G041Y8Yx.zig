...
const HSI_DIV8 = struct {

        pub fn get(_:*const HSI_DIV8) comptime_int {
            if (!@hasDecl(this, "HSIRC_inst")) {
              @compileError("No Input HSIRC for HSI_DIV8\n");
            }
