    ...
    const ClockStruct = struct {
        ...
        const HSIDiv = struct {
            ...
            pub fn get(self: *const HSIDiv) comptime_int {
                if (!@hasDecl(@TypeOf(this), "HSIRC_inst")) {
        ...
        const MCO1Div = struct {
            ...
            pub fn get(self: *const MCO1Div) comptime_int {
                if (!@hasDecl(@TypeOf(this), "MCO1Mult_inst")) {
        ...
        const MCO2Div = struct {
            ...
            pub fn get(self: *const MCO2Div) comptime_int {
                if (!@hasDecl(@TypeOf(this), "MCO2Mult_inst")) {
        ...
        const CDCPRE = struct {
            ...
            pub fn get(self: *const CDCPRE) comptime_int {
                if (!@hasDecl(@TypeOf(this), "SysCLKOutput_inst")) {
        ...
        const CortexPrescaler = struct {
            ...
            pub fn get(self: *const CortexPrescaler) comptime_int {
                if (!@hasDecl(@TypeOf(this), "CDCPREOutput_inst")) {
        ...
        const CDPPRE = struct {
            ...
            pub fn get(self: *const CDPPRE) comptime_int {
                if (!@hasDecl(@TypeOf(this), "AHBOutput_inst")) {
        ...
        const Tim1Mul = struct {
            pub fn get() comptime_int {
                if (!@hasDecl(@TypeOf(this), "CDPPRE1_inst")) {
        ...
        const Tim2Mul = struct {
            pub fn get() comptime_int {
                if (!@hasDecl(@TypeOf(this), "CDPPRE2_inst")) {
        ...
        const DIVM1 = struct {
            ...
            pub fn get(self: *const DIVM1) comptime_int {
                if (!@hasDecl(@TypeOf(this), "PLLSource_inst")) {
        ...
        const DIVN1 = struct {
            ...
            pub fn get(self: *const DIVN1) comptime_int {
                if (!@hasDecl(@TypeOf(this), "DIVM1_inst")) {
                    @compileError("No Input DIVM1 for DIVN1\n");
                } else if (!@hasDecl(@TypeOf(this), "PLLFRACN_inst")) {
                ...
                const max_frac: comptime_float = @floatFromInt(this.PLLFRACN_inst.max());
        ...
        const DIVP1 = struct {
            ...
            pub fn get(self: *const DIVP1) comptime_int {
                if (!@hasDecl(@TypeOf(this), "DIVN1_inst")) {
        ...
        const DIVN2 = struct {
            ...
            pub fn get(self: *const DIVN2) comptime_int {
                if (!@hasDecl(@TypeOf(this), "DIVM2_inst")) {
                    @compileError("No Input DIVM2 for DIVN2\n");
                } else if (!@hasDecl(@TypeOf(this), "PLL2FRACN_inst")) {
                ...
                const max_frac: comptime_float = @floatFromInt(this.PLL2FRACN_inst.max());
                const multi: comptime_float = self.value.get();
                return @intFromFloat((from_input * (multi + (frac / max_frac))));
            }
        };
        ...
        const DIVP2 = struct {
            ...
            pub fn get(self: *const DIVP2) comptime_int {
                if (!@hasDecl(@TypeOf(this), "DIVN2_inst")) {
        ...
        const DIVN3 = struct {
            ...
            pub fn get(self: *const DIVN3) comptime_int {
                if (!@hasDecl(@TypeOf(this), "DIVM3_inst")) {
                    @compileError("No Input DIVM3 for DIVN3\n");
                } else if (!@hasDecl(@TypeOf(this), "PLL3FRACN_inst")) {
                ...
                const max_frac: comptime_float = @floatFromInt(this.PLL3FRACN_inst.max());
                const multi: comptime_float = self.value.get();
                return @intFromFloat((from_input * (multi + (frac / max_frac))));
            }
        };
        ...
        const DIVP3 = struct {
            ...
            pub fn get(self: *const DIVP3) comptime_int {
                if (!@hasDecl(@TypeOf(this), "DIVN3_inst")) {
        ...
        const HSERTCDevisor = struct {
            ...
            pub fn get(self: *const HSERTCDevisor) comptime_int {
                if (!@hasDecl(@TypeOf(this), "HSEOSC_inst")) {
        ...
        const HSIDiv_inst = HSIDiv{ .value = conf.HSIDivConf };
        const HSEOSC_inst = HSEOSC{ .value = conf.HSEOSCConf };
        const LSIRC_inst = LSIRC{ .value = conf.LSIRCConf };
        const LSEOSC_inst = LSEOSC{ .value = conf.LSEOSCConf };
        const CSIRC_inst = CSIRC{};
        const RC48_inst = RC48{};
        const I2S_CKIN_inst = I2S_CKIN{};
        const SysClkSource_inst = SysClkSource{ .value = conf.SysClkSourceConf };
        pub const SysCLKOutput_inst = SysCLKOutput{ .value = conf.SysCLKOutputConf };
        const MCO1Mult_inst = MCO1Mult{ .value = conf.MCO1MultConf };
        const MCO1Div_inst = MCO1Div{ .value = conf.MCO1DivConf };
        pub const MCO1Pin_inst = MCO1Pin{};
        const MCO2Mult_inst = MCO2Mult{ .value = conf.MCO2MultConf };
        const MCO2Div_inst = MCO2Div{ .value = conf.MCO2DivConf };
        pub const MCO2Pin_inst = MCO2Pin{};
        const traceClkSource_inst = traceClkSource{ .value = conf.traceClkSourceConf };
        pub const TraceCLKOutput_inst = TraceCLKOutput{};
        const CDCPRE_inst = CDCPRE{ .value = conf.CDCPREConf };
        pub const CDCPREOutput_inst = CDCPREOutput{ .value = conf.CDCPREOutputConf };
        pub const CpuClockOutput_inst = CpuClockOutput{ .value = conf.CpuClockOutputConf };
        const CortexPrescaler_inst = CortexPrescaler{ .value = conf.CortexPrescalerConf };
        pub const CortexSysOutput_inst = CortexSysOutput{ .value = conf.CortexSysOutputConf };
        const HPRE_inst = HPRE{ .value = conf.HPREConf };
        pub const AHBOutput_inst = AHBOutput{ .value = conf.AHBOutputConf };
        pub const AXIClockOutput_inst = AXIClockOutput{ .value = conf.AXIClockOutputConf };
        pub const HCLK3Output_inst = HCLK3Output{ .value = conf.HCLK3OutputConf };
        const CDPPRE_inst = CDPPRE{ .value = conf.CDPPREConf };
        pub const APB3Output_inst = APB3Output{ .value = conf.APB3OutputConf };
        const CDPPRE1_inst = CDPPRE1{ .value = conf.CDPPRE1Conf };
        const Tim1Mul_inst = Tim1Mul{};
        pub const Tim1Output_inst = Tim1Output{};
        pub const AHB12Output_inst = AHB12Output{ .value = conf.AHB12OutputConf };
        pub const APB1Output_inst = APB1Output{ .value = conf.APB1OutputConf };
        const CDPPRE2_inst = CDPPRE2{ .value = conf.CDPPRE2Conf };
        pub const APB2Output_inst = APB2Output{ .value = conf.APB2OutputConf };
        const Tim2Mul_inst = Tim2Mul{};
        pub const Tim2Output_inst = Tim2Output{};
        pub const AHB4Output_inst = AHB4Output{};
        const SRDPPRE_inst = SRDPPRE{ .value = conf.SRDPPREConf };
        pub const APB4Output_inst = APB4Output{ .value = conf.APB4OutputConf };
        const PLLSource_inst = PLLSource{ .value = conf.PLLSourceConf };
        const CKPERSource_inst = CKPERSource{ .value = conf.CKPERSourceConf };
        pub const CKPERoutput_inst = CKPERoutput{};
        const DIVM1_inst = DIVM1{ .value = conf.DIVM1Conf };
        const DIVM2_inst = DIVM2{ .value = conf.DIVM2Conf };
        const DIVM3_inst = DIVM3{ .value = conf.DIVM3Conf };
        const DIVN1_inst = DIVN1{ .value = conf.DIVN1Conf };
        const PLLFRACN_inst = PLLFRACN{ .value = conf.PLLFRACNConf };
        const DIVP1_inst = DIVP1{ .value = conf.DIVP1Conf };
        const DIVQ1_inst = DIVQ1{ .value = conf.DIVQ1Conf };
        pub const DIVQ1output_inst = DIVQ1output{};
        const DIVR1_inst = DIVR1{ .value = conf.DIVR1Conf };
        pub const DIVR1output_inst = DIVR1output{};
        const DIVN2_inst = DIVN2{ .value = conf.DIVN2Conf };
        const PLL2FRACN_inst = PLL2FRACN{ .value = conf.PLL2FRACNConf };
        const DIVP2_inst = DIVP2{ .value = conf.DIVP2Conf };
        pub const DIVP2output_inst = DIVP2output{};
        const DIVQ2_inst = DIVQ2{ .value = conf.DIVQ2Conf };
        pub const DIVQ2output_inst = DIVQ2output{};
        const DIVR2_inst = DIVR2{ .value = conf.DIVR2Conf };
        pub const DIVR2output_inst = DIVR2output{};
        const DIVN3_inst = DIVN3{ .value = conf.DIVN3Conf };
        const PLL3FRACN_inst = PLL3FRACN{ .value = conf.PLL3FRACNConf };
        const DIVP3_inst = DIVP3{ .value = conf.DIVP3Conf };
        pub const DIVP3output_inst = DIVP3output{};
        const DIVQ3_inst = DIVQ3{ .value = conf.DIVQ3Conf };
        pub const DIVQ3output_inst = DIVQ3output{};
        const DIVR3_inst = DIVR3{ .value = conf.DIVR3Conf };
        pub const LTDCOutput_inst = LTDCOutput{};
        pub const DIVR3output_inst = DIVR3output{};
        const HSERTCDevisor_inst = HSERTCDevisor{ .value = conf.HSERTCDevisorConf };
        const RTCClkSource_inst = RTCClkSource{ .value = conf.RTCClkSourceConf };
        ...
        const SPI123Mult_inst = SPI123Mult{ .value = conf.SPI123MultConf };
        pub const SPI123output_inst = SPI123output{};
        const SAI1Mult_inst = SAI1Mult{ .value = conf.SAI1MultConf };
        pub const DFSDMACLKoutput_inst = DFSDMACLKoutput{};
        pub const SAI1output_inst = SAI1output{};
        const SAI2BMult_inst = SAI2BMult{ .value = conf.SAI2BMultConf };
        pub const SAI2Boutput_inst = SAI2Boutput{};
        const SAI2AMult_inst = SAI2AMult{ .value = conf.SAI2AMultConf };
        pub const SAI2Aoutput_inst = SAI2Aoutput{};
        const RNGMult_inst = RNGMult{ .value = conf.RNGMultConf };
        pub const RNGoutput_inst = RNGoutput{};
        const I2C123Mult_inst = I2C123Mult{ .value = conf.I2C123MultConf };
        pub const I2C123output_inst = I2C123output{};
        const I2C4Mult_inst = I2C4Mult{ .value = conf.I2C4MultConf };
        pub const I2C4output_inst = I2C4output{};
        const SPDIFMult_inst = SPDIFMult{ .value = conf.SPDIFMultConf };
        pub const SPDIFoutput_inst = SPDIFoutput{};
        const QSPIMult_inst = QSPIMult{ .value = conf.QSPIMultConf };
        pub const QSPIoutput_inst = QSPIoutput{};
        const FMCMult_inst = FMCMult{ .value = conf.FMCMultConf };
        pub const FMCoutput_inst = FMCoutput{};
        const SWPMult_inst = SWPMult{ .value = conf.SWPMultConf };
        pub const SWPoutput_inst = SWPoutput{};
        const SDMMCMult_inst = SDMMCMult{ .value = conf.SDMMCMultConf };
        pub const SDMMCoutput_inst = SDMMCoutput{};
        const DFSDMMult_inst = DFSDMMult{ .value = conf.DFSDMMultConf };
        pub const DFSDMoutput_inst = DFSDMoutput{};
        const DFSDM2Mult_inst = DFSDM2Mult{ .value = conf.DFSDM2MultConf };
        pub const DFSDM2output_inst = DFSDM2output{};
        const USART16Mult_inst = USART16Mult{ .value = conf.USART16MultConf };
        pub const USART16output_inst = USART16output{};
        const USART234578Mult_inst = USART234578Mult{ .value = conf.USART234578MultConf };
        pub const USART234578output_inst = USART234578output{};
        const LPUART1Mult_inst = LPUART1Mult{ .value = conf.LPUART1MultConf };
        pub const LPUART1output_inst = LPUART1output{};
        const LPTIM1Mult_inst = LPTIM1Mult{ .value = conf.LPTIM1MultConf };
        pub const LPTIM1output_inst = LPTIM1output{};
        const LPTIM345Mult_inst = LPTIM345Mult{ .value = conf.LPTIM345MultConf };
        pub const LPTIM345output_inst = LPTIM345output{};
        const LPTIM2Mult_inst = LPTIM2Mult{ .value = conf.LPTIM2MultConf };
        pub const LPTIM2output_inst = LPTIM2output{};
        const SPI6Mult_inst = SPI6Mult{ .value = conf.SPI6MultConf };
        pub const SPI6output_inst = SPI6output{};
        pub const DFSDM2ACLKoutput_inst = DFSDM2ACLKoutput{};
        const SPI45Mult_inst = SPI45Mult{ .value = conf.SPI45MultConf };
        pub const SPI45output_inst = SPI45output{};
        const USBMult_inst = USBMult{ .value = conf.USBMultConf };
        pub const USBoutput_inst = USBoutput{ .value = conf.USBoutputConf };
        const FDCANMult_inst = FDCANMult{ .value = conf.FDCANMultConf };
        pub const FDCANoutput_inst = FDCANoutput{};
        const ADCMult_inst = ADCMult{ .value = conf.ADCMultConf };
        pub const ADCoutput_inst = ADCoutput{ .value = conf.ADCoutputConf };
        const CECMult_inst = CECMult{ .value = conf.CECMultConf };
