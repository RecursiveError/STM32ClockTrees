...
pub fn Clock(comptime conf: Config) type {
    const ClockStruct = struct {
        ...
        const SWPMIMultType = struct {
            value: SWPMIMultConf,
            pub fn get(comptime self: SWPMIMultType) comptime_int {
                return switch (self.value) {
                    .APB1Prescaler => APB1Prescaler.get(),
                    .HSIRC => HSIRC.get(),
                };
        ...
        const SWPMIoutputType = struct {
            pub fn get(_: *const SWPMIoutputType) comptime_int {
                return SWPMIMult.get();
            }
        };
        ...
        const SWPMIMult = SWPMIMultType{ .value = conf.SWPMIMult };
        pub const SWPMIoutput = SWPMIoutputType{};
