...
const SysCLKOutput = struct {
  pub fn get(_:*const SysCLKOutput) comptime_int {
      ...
      if(from_input < 0){
          ...
          @compileError(std.fmt.comptimePrint("OverFlow clock from SysClkSource on SysCLKOutput | recive {d} max 24000000\n", .{from_input}));
      }
      return from_input;
  }
};
...
const MCOoutput = struct {
  pub fn get(_:*const MCOoutput) comptime_int {
      ...
      if(from_input < 0){
          ...
          @compileError(std.fmt.comptimePrint("OverFlow clock from MCOMult on MCOoutput | recive {d} max 24000000\n", .{from_input}));
      }
      return from_input;
  }
};
...
const AHBOutput = struct {
  pub fn get(_:*const AHBOutput) comptime_int {
      ...
      if(from_input < 0){
          ...
          @compileError(std.fmt.comptimePrint("OverFlow clock from AHBPrescaler on AHBOutput | recive {d} max 24000000\n", .{from_input}));
      }
      return from_input;
  }
};
...
const APB1Output = struct {
  pub fn get(_:*const APB1Output) comptime_int {
      ...
      if(from_input < 0){
          ...
          @compileError(std.fmt.comptimePrint("OverFlow clock from APB1Prescaler on APB1Output | recive {d} max 24000000\n", .{from_input}));
      }
      return from_input;
  }
};
...
const APB2Output = struct {
  pub fn get(_:*const APB2Output) comptime_int {
      ...
      if(from_input < 0){
          ...
          @compileError(std.fmt.comptimePrint("OverFlow clock from APB2Prescaler on APB2Output | recive {d} max 24000000\n", .{from_input}));
      }
      return from_input;
  }
};
