...
const TIMMUX2 = struct {
  value: TIMMUX2Conf,
  pub fn get(comptime self: TIMMUX2) comptime_int {
      return switch(self.value) {
.TIMMUL => TIMMUL_inst.get(),
 .TimPrescOut1 => TimPrescOut1_inst.get(),
       };
   }
};
const TIM2out = struct{
  pub fn get(_:*const TIM2out) comptime_int{
      return TIMMUX2_inst.get();
  }
};
const TIMMUX3 = struct {
  value: TIMMUX3Conf,
  pub fn get(comptime self: TIMMUX3) comptime_int {
      return switch(self.value) {
.TIMMUL => TIMMUL_inst.get(),
 .TimPrescOut1 => TimPrescOut1_inst.get(),
       };
...
const TIM3out = struct{
  pub fn get(_:*const TIM3out) comptime_int{
      return TIMMUX3_inst.get();
  }
};
...
const TIMMUX15 = struct {
  value: TIMMUX15Conf,
  pub fn get(comptime self: TIMMUX15) comptime_int {
      return switch(self.value) {
.TIMMUL => TIMMUL_inst.get(),
 .TimPrescOut2 => TimPrescOut2_inst.get(),
       };
...
const TIM15out = struct{
  pub fn get(_:*const TIM15out) comptime_int{
      return TIMMUX15_inst.get();
  }
};
const TIMMUX16 = struct {
  value: TIMMUX16Conf,
  pub fn get(comptime self: TIMMUX16) comptime_int {
      return switch(self.value) {
.TIMMUL => TIMMUL_inst.get(),
 .TimPrescOut2 => TimPrescOut2_inst.get(),
       };
...
const TIM16out = struct{
  pub fn get(_:*const TIM16out) comptime_int{
      return TIMMUX16_inst.get();
  }
};
const TIMMUX17 = struct {
  value: TIMMUX17Conf,
  pub fn get(comptime self: TIMMUX17) comptime_int {
      return switch(self.value) {
.TIMMUL => TIMMUL_inst.get(),
 .TimPrescOut2 => TimPrescOut2_inst.get(),
       };
...
const TIM17out = struct{
  pub fn get(_:*const TIM17out) comptime_int{
      return TIMMUX17_inst.get();
  }
};
const TIMMUX20 = struct {
  value: TIMMUX20Conf,
  pub fn get(comptime self: TIMMUX20) comptime_int {
      return switch(self.value) {
.TIMMUL => TIMMUL_inst.get(),
 .TimPrescOut2 => TimPrescOut2_inst.get(),
       };
...
const TIM20out = struct{
  pub fn get(_:*const TIM20out) comptime_int{
      return TIMMUX20_inst.get();
  }
};
...
const TIMMUX2_inst = TIMMUX2{ .value = conf.TIMMUX2};
pub const TIM2out_inst = TIM2out{};
const TIMMUX3_inst = TIMMUX3{ .value = conf.TIMMUX3};
pub const TIM3out_inst = TIM3out{};
...
const TIMMUX15_inst = TIMMUX15{ .value = conf.TIMMUX15};
pub const TIM15out_inst = TIM15out{};
const TIMMUX16_inst = TIMMUX16{ .value = conf.TIMMUX16};
pub const TIM16out_inst = TIM16out{};
const TIMMUX17_inst = TIMMUX17{ .value = conf.TIMMUX17};
pub const TIM17out_inst = TIM17out{};
const TIMMUX20_inst = TIMMUX20{ .value = conf.TIMMUX20};
pub const TIM20out_inst = TIM20out{};
