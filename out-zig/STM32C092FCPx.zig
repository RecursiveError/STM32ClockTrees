...
pub fn Clock(comptime conf: Config) type {
    const ClockStruct = struct {
        ...
        const FDCAN1MultType = struct {
            value: FDCAN1MultConf,
            pub fn get(comptime self: FDCAN1MultType) comptime_int {
                return switch (self.value) {
                    .APBPrescaler => APBPrescaler.get(),
                    .HSIKER => HSIKER.get(),
                    .HSEOSC => HSEOSC.get(),
        ...
        const FDCAN1outputType = struct {
            pub fn get(_: *const FDCAN1outputType) comptime_int {
                return FDCAN1Mult.get();
            }
        };
        ...
        const FDCAN1Mult = FDCAN1MultType{ .value = conf.FDCAN1Mult };
        pub const FDCAN1output = FDCAN1outputType{};
