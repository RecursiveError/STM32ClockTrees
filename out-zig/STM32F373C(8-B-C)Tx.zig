...
const SDADCPresc = struct {
        value: SDADCPrescConf,

        pub fn get(self: *const SDADCPresc) comptime_int {
...
const SDADCoutput = struct {
  pub fn get(_:*const SDADCoutput) comptime_int {
      const from_input = SDADCPresc_inst.get();
...
const ADCPresc = struct {
        value: ADCPrescConf,

        pub fn get(self: *const ADCPresc) comptime_int {
...
const SDADCPresc_inst = SDADCPresc{ .value = conf.SDADCPresc};
pub const SDADCoutput_inst = SDADCoutput{};
...
const ADCPresc_inst = ADCPresc{ .value = conf.ADCPresc};
